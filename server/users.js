...
const UsersRouter = () => {
    ...
    router
        ...
        .post(Users.autorize([scopes.Admin]), function (req, res, next) {
            ...
            Users.create(body)
                .then((user) => {
                    io.sockets.emit('admin_notification', { message: 'Add new user', key: 'User' });
                    res.status(200);
                    res.send();
                    next();
                })
        ...
        .get(Users.autorize([scopes.Admin, scopes.Member, scopes.NonMember]), function (req, res, next) {
    ...
    router.route('/:userId').put(Users.autorize([scopes.Admin]), function (req, res, next) {
    ...
    router.route('/member').get(Users.autorize([scopes.Admin, scopes.Member, scopes.NonMember]), function (req, res, next) {
    ...
    router.route('/member/:memberId').put(Users.autorize([scopes.Admin]), function (req, res, next) {
        console.log('update a member by id');
    ...
    router.route('/member/tax/:taxNumber').get(Users.autorize([scopes.Admin, scopes.Member, scopes.NonMember]), function (req, res, next) {
    ...
    router.route('/perfil').get(Users.autorize([scopes.NonMember, scopes.Member]), function (req, res, next) {
